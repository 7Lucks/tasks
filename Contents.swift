...
someSet1.intersection(someSet2).sorted()
...
func changeValue1 (string: String){
        print("\(string)d")
    }
changeValue1(string: "abc")
...
//func operate1 (num1: Int, num2: Int) -> Int{
//    func operate2 (num3: Int) -> Int{
//    let operate3 = (num3 * 2)
//        return operate1(num1: <#T##Int#>, num2: <#T##Int#>)
//
